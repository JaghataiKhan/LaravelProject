...
<div class="w-full md:w-1/2 xl:w-1/3 px-4">
    <div class="bg-white rounded-lg mb-10">
        ...
        <section x-data="{
          videoOpen: false,
          videoUrl: 'https://www.youtube.com/embed/<?php echo e($video->url); ?>?autoplay=1',
          url: '',
        }">
            <div class="flex flex-wrap justify-center">
                <div class="w-full aspect-video relative z-20">
                    <div class="w-full h-full absolute top-0 left-0 p-3">
                        <!-- Thumbnail -->
                        <img
                            src="https://i.ytimg.com/vi/<?php echo e($video->url); ?>/original.jpg"
                            alt="image"
                            class="w-full h-full object-center object-cover rounded-lg"
                        />
                        <!-- /Thumbnail -->
                    </div>
                    <div class="absolute top-0 left-0 w-full h-full flex items-center justify-center bg-emerald-500 bg-opacity-0 z-10">
                        <!-- Play Video -->
                        <a
                            href="javascript:void(0)"
                            @click="videoOpen = true; url = videoUrl"
                            class="flex items-center justify-center w-20 md:w-[70px] h-20 md:h-[70px] rounded-full bg-white text-emerald-500 hover:text-emerald-700 absolute z-20"
                        >
                <span
        ...
        <!-- Video Content -->
        <div class="p-6 xl:p-7 2xl:p-9 h-[450px] overflow-hidden text-center">
            <h3>
                <a
                    href="https://youtu.be/<?php echo e($video->url); ?>"
                    target="_blank "
                    class="font-bold text-dark text-lg mb-4 block hover:text-emerald-500"
                >
                    <?php echo e($video->title); ?>

                </a>
            </h3>
            <p class="text-base text-body-color leading-relaxed mb-10 pb-5">
...
<?php /**PATH /var/www/html/LaravelProjects/impetus-1/resources/views/components/video-section-item.blade.php ENDPATH**/ ?>