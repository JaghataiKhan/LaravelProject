    ...
    <div class="container">
        <div class="flex flex-wrap lg:justify-between -mx-4">
            <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
               ...
               <span class="block mb-4 text-base text-emerald-500 font-semibold">
               Contact Us
               </span>
                    <h2
                        class="
                    ...
                    <div class="flex mb-8 max-w-[370px] w-full">
                     ...
                     "
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-base text-body-color"><?php echo e($contact->phone); ?></p>
                        </div>
                    </div>
                    <div class="flex mb-8 max-w-[370px] w-full">
                        <div
                     ...
                     "
                        ...
                        <div class="w-full">
                            ...
                            <p class="text-base text-body-color"><?php echo e($contact->email); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
                <div class="bg-white relative rounded-lg p-8 sm:p-12 shadow-lg">
                    <form method="POST" id="frm-create-request">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-6 form-group">
                            <input type="text"
                                ...
                                class="w-full rounded py-3 px-[14px] text-body-color text-base border border-[f0f0f0] outline-none focus-visible:shadow-none focus:border-emerald-600"/>
                        ...
                        <div class="mb-6">
                            <input
                                ...
                                class="form-control w-full rounded py-3 px-[14px] text-body-color text-base border border-[f0f0f0] outline-none focus-visible:shadow-none focus:border-emerald-600"/>

                            <p class="text-red-500 text-xs italic" id="mobileError"></p>
                     ...
                     <textarea
                         ...
                         name="user_message" value="<?php echo e(old('user_message')); ?>"
                         class="w-full rounded py-3 px-[14px] text-body-color text-base border border-[f0f0f0] resize-none outline-none focus-visible:shadow-none focus:border-emerald-600"></textarea>

                            <p class="text-red-500 text-xs italic" id="messageError"></p>

                        </div>
                        <div>
                            <button
                                type="submit"
                                class="btn btn-success save-data w-full text-white bg-emerald-500 rounded border border-primary p-3 transition hover:bg-opacity-90 text-lg ">
                                Send Message
                            </button>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.contacts-dot-top','data' => []]); ?>
<?php $component->withName('contacts-dot-top'); ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.contacts-dot-bot','data' => []]); ?>
<?php $component->withName('contacts-dot-bot'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
<?php echo $__env->renderComponent(); ?>
...
<?php /**PATH /var/www/html/LaravelProjects/impetus-1/resources/views/components/pages/contact-section.blade.php ENDPATH**/ ?>